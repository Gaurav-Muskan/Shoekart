		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comprojectsshoekart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprojectsshoekart-display": {
								"semanticObject": "comprojectsshoekart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.projects.shoekart",
									"url": sap.ui.require.toUrl("com/projects/shoekart")
								}
							}
						}
					}
